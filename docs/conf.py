...
copyright = '2018, Narrativ AI, Inc.'
author = 'Narrativ'
...
# Use Read the Docs theme on all build environments for consistency:
# https://docs.readthedocs.io/en/latest/theme.html#read-the-docs-theme
